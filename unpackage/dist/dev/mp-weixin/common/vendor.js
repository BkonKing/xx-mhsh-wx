...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"mhsh","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default = {
  ...
  methods: {
    handleLoad: function handleLoad() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$_this2$getList, data, _this2$listData;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!
                _this2.isFinish) {_context.next = 2;break;}return _context.abrupt("return");case 2:


                _this2.loadMoreStatus = 'loading';_context.next = 5;return (


                  _this2.getListData());case 5:_yield$_this2$getList = _context.sent;data = _yield$_this2$getList.data;
                _this2.loadMoreStatus = 'more';
                if (data && data.length > 0) {
                  (_this2$listData = _this2.listData).push.apply(_this2$listData, _toConsumableArray(data));
                }
                _this2.isFinish = !data || data.length < 10;case 10:case "end":return _context.stop();}}}, _callee);}))();
    },
...
var _personage = __webpack_require__(/*! @/api/personage.js */ 38);
...
var store = {
  ...
  mutations: {
    ...
    setVisitorList: function setVisitorList(state, list) {
      state.visitorList = list;
    },
    setHouseSelected: function setHouseSelected(state, obj) {
    ...
    deleteKeepAlive: function deleteKeepAlive(state, name) {
      var index = state.keepAliveList.indexOf(name);
      if (index !== -1) {
        state.keepAliveList.splice(index, 1);
      }
    },
    clearKeepAlive: function clearKeepAlive(state) {
      state.keepAliveList = [];
    },
    setPaddingTop: function setPaddingTop(state, value) {
      state.paddingTop = value;
    },
    setPaddingBottom: function setPaddingBottom(state, value) {
      state.paddingBottom = value;
    },
    setTemporaryType: function setTemporaryType(state, value) {
      state.temporaryType = value;
    },
    setMobile_info: function setMobile_info(state, value) {
      state.mobile_info = value;
    },
    setMap_info: function setMap_info(state, value) {
      state.map_info = value;
    },
    setShare_params: function setShare_params(state, value) {
      state.share_params = value;
    },
    setWinResize: function setWinResize(state, value) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.yzmLogin = yzmLogin;exports.verifCode = verifCode;exports.pwdLogin = pwdLogin;exports.outLogin = outLogin;exports.getMyAccount = getMyAccount;exports.uImages = uImages;exports.getAgreementContent = getAgreementContent;exports.getAllAgreement = getAllAgreement;exports.setUserPostion = setUserPostion;exports.cancelLogout = cancelLogout;exports.wxLogin = wxLogin;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function getAllAgreement() {
  return _request.default.get('/ulogin/agreement/allAgreement');
}
...
var _util = __webpack_require__(/*! @/utils/util */ 37);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 397));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 398));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 399));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 478));
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 544)["default"]))
...
{var name = _ref.name,message = _ref.message,_ref$title = _ref.title,title = _ref$title === void 0 ? '提示' : _ref$title,_ref$confirmButtonTex = _ref.confirmButtonText,confirmButtonText = _ref$confirmButtonTex === void 0 ? '去开启' : _ref$confirmButtonTex;
  return new Promise(function (resolve, reject) {
