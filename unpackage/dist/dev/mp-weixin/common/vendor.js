...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"美好生活","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 109:
/*!************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/mixins/list.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default = {
  ...
  watch: {
    isFinish: function isFinish(newValue) {
      if (newValue) {
  ...
  methods: {
    handleLoad: function handleLoad() {var _arguments = arguments,_this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var isContinuous, _yield$_this2$getList, data, _this2$listData;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:isContinuous = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : false;if (!
                _this2.isFinish) {_context.next = 3;break;}return _context.abrupt("return");case 3:


                _this2.loadMoreStatus = 'loading';_context.next = 6;return (


                  _this2.getListData());case 6:_yield$_this2$getList = _context.sent;data = _yield$_this2$getList.data;
                _this2.loadMoreStatus = 'more';
                if (data && data.length > 0) {
                  (_this2$listData = _this2.listData).push.apply(_this2$listData, _toConsumableArray(data));
                }
                _this2.isFinish = !data || data.length < 10;
                !_this2.isFinish && isContinuous && _this2.getNextPage();case 12:case "end":return _context.stop();}}}, _callee);}))();
    },
...
/***/ 12:
/*!************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/store/index.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = {
  ...
  mutations: {
    setUserInfo: function setUserInfo(state, value) {
      var val = value && typeof value === 'string' ? JSON.parse(value) :
      value;
      state.userInfo = val;
      uni.setStorageSync('userInfo', val);
    },
    setOpenId: function setOpenId(state, value) {
      state.openId = value;
      uni.setStorageSync('openId', value);
    },
    setCurrentProject: function setCurrentProject(state, obj) {
      state.current_project = obj;
      uni.setStorageSync('currentProject', obj);
    },
    setMobileInfo: function setMobileInfo(state, value) {
      state.mobileInfo = value;
    },
    setTempData: function setTempData(state, value) {
      state.tempData = value;
    },
    setLoginModal: function setLoginModal(state, value) {
  ...
  actions: {
    outLogin: function outLogin(_ref)

    {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var commit;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit;_context.next = 3;return (
                  new Promise(function (resolve, reject) {
                    uni.showLoading({
                      title: '加载中' });

                    (0, _user.outLogin)().then(function (res) {
                      uni.hideLoading();
                      if (res.success) {
                        (0, _util.clearUserInfo)();
                        resolve();
                      } else {
                        reject(res);
                      }
    ...
    getHouse: function getHouse(_ref2)

    {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var commit;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:commit = _ref2.commit;_context2.next = 3;return (
                  (0, _personage.bindingHouse)().then(function (_ref3)
    ...
    // 刷新用户信息
    getMyAccount: function getMyAccount(_ref4)

    {var commit = _ref4.commit;
      return new Promise(function (resolve, reject) {
        (0, _user.getMyAccount)().then(function (_ref5)
    ...
    wxLogin: function wxLogin(_ref6)
        ...
        wx.login({
          success: function success(res) {var
            ...
            if (code) {
              ...
              (0, _user.wxLogin)({
                xcx_code: code }).
              then(function (_ref7) {var data = _ref7.data;
...
/***/ 17:
/*!*********************************************!*\
  !*** C:/Coding/Project/mhsh-wx/api/user.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.yzmLogin = yzmLogin;exports.verifCode = verifCode;exports.pwdLogin = pwdLogin;exports.outLogin = outLogin;exports.getMyAccount = getMyAccount;exports.getAgreementContent = getAgreementContent;exports.getAllAgreement = getAllAgreement;exports.setUserPostion = setUserPostion;exports.cancelLogout = cancelLogout;exports.wxLogin = wxLogin;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 18));
var _config = _interopRequireDefault(__webpack_require__(/*! @/api/config */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// 退出登录
function outLogin() {
  return _request.default.post('/ulogin/login/outLogin');
}
...
function getAgreementContent(data) {
  return (0, _request.default)({
...
function wxLogin(data) {
  return (0, _request.default)({
    ...
    baseURL: "".concat(_config.default.baseUrl, "/xcx/api/v1"),
    method: 'post',
    data: data });
...
/***/ 18:
/*!**************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/utils/request.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _js_sdk = _interopRequireDefault(__webpack_require__(/*! @/uni_modules/u-ajax/js_sdk */ 19));
var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 12));
var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ 32));
var _util = __webpack_require__(/*! @/utils/util */ 37);


var _config = _interopRequireDefault(__webpack_require__(/*! @/api/config */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var service = _js_sdk.default.create({
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded' },

  baseURL: "".concat(_config.default.baseUrl, "/app/api/v1"),
...
function (config) {
  ...
  if (typeof config.headers.ProjectId === 'undefined') {
    // 获取当前项目
    var project = _store.default.getters.currentProject;
...
function (response) {var
  ...
  response.status,data = response.data,config = response.config;var
  ...
  if (status == 401 || code == 401) {
    if (_store.default.state.loginModal) {
      return Promise.reject(code);
    }
    _store.default.commit('setLoginModal', true);
    uni.showModal({
      title: '提示',
      ...
      complete: function complete() {
        _store.default.commit('setLoginModal', false);
      } });
...
/***/ 19:
/*!********************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/index.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _Ajax = _interopRequireDefault(__webpack_require__(/*! ./lib/core/Ajax */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 20:
/*!****************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/core/Ajax.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = Ajax;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));var _InterceptorManager = _interopRequireDefault(__webpack_require__(/*! ./InterceptorManager */ 21));
...
var _detachConfig2 = _interopRequireDefault(__webpack_require__(/*! ../helpers/detachConfig */ 25));
var _mergeConfig = _interopRequireDefault(__webpack_require__(/*! ../helpers/mergeConfig */ 27));
var _dispatchRequest = _interopRequireDefault(__webpack_require__(/*! ./dispatchRequest */ 28));
var _handleCancel = __webpack_require__(/*! ./handleCancel */ 31);
var _defaults = _interopRequireWildcard(__webpack_require__(/*! ../defaults */ 29));
var _utils = __webpack_require__(/*! ../utils */ 24);function _getRequireWildcardCache() {if (typeof WeakMap !== "function") return null;var cache = new WeakMap();_getRequireWildcardCache = function _getRequireWildcardCache() {return cache;};return cache;}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;}if (obj === null || typeof obj !== "object" && typeof obj !== "function") {return { default: obj };}var cache = _getRequireWildcardCache();if (cache && cache.has(obj)) {return cache.get(obj);}var newObj = {};var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor;for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null;if (desc && (desc.get || desc.set)) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}newObj.default = obj;if (cache) {cache.set(obj, newObj);}return newObj;}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}

function Ajax(defaultConfig) {
  // 挂载当前实例配置
  var config = typeof defaultConfig === 'object' ? (0, _utils.merge)(defaultConfig) : defaultConfig;
  ...
  function ajax() {
    ...
    // 将请求拦截遍历添加到链前面
    ajax.interceptors.request.forEach.desc(function (_ref) {var fulfilled = _ref.fulfilled,rejected = _ref.rejected;return (
        chain.unshift(fulfilled, rejected));});


    // 将响应拦截遍历添加到链后面
    ajax.interceptors.response.forEach.asc(function (_ref2) {var fulfilled = _ref2.fulfilled,rejected = _ref2.rejected;return (
...
/***/ 21:
/*!******************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/core/InterceptorManager.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 22:
/*!***********************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/adapters/Request.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = RequestConstructor;function RequestConstructor() {
  var Request = function Request(executor) {
  ...
  Request.onHeadersReceived = function onHeadersReceived(fn) {
    ...
    if (Request.onHeadersReceivedCallback && Request.task) {var _Request$task$onHeade, _Request$task;
  ...
  Request.offHeadersReceived = function offHeadersReceived(fn) {
    ...
    if (Request.offHeadersReceivedCallback && Request.task) {var _Request$task$offHead, _Request$task2;
  ...
  // 中断请求任务
  Request.prototype.abort = function abort() {var _Request$task3;
...
/***/ 23:
/*!***********************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/helpers/buildURL.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = buildURL;var _utils = __webpack_require__(/*! ../utils */ 24);
...
/***/ 24:
/*!************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/utils.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 25:
/*!***************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/helpers/detachConfig.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = detachConfig;var _isCallback = _interopRequireDefault(__webpack_require__(/*! ./isCallback */ 26));
...
/***/ 26:
/*!*************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/helpers/isCallback.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 27:
/*!**************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/helpers/mergeConfig.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = mergeConfig;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));var _utils = __webpack_require__(/*! ../utils */ 24);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/***/ 28:
/*!***************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/core/dispatchRequest.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = dispatchRequest;var _buildURL = _interopRequireDefault(__webpack_require__(/*! ../helpers/buildURL */ 23));
var _isCallback = _interopRequireDefault(__webpack_require__(/*! ../helpers/isCallback */ 26));
var _utils = __webpack_require__(/*! ../utils */ 24);
var _defaults = __webpack_require__(/*! ../defaults */ 29);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 29:
/*!***************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/defaults.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.HEADER = exports.METHOD = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ./adapters/http */ 30));
var _utils = __webpack_require__(/*! ./utils */ 24);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 293:
/*!*************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 30:
/*!********************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/adapters/http.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 31:
/*!************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/u-ajax/js_sdk/lib/core/handleCancel.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var parse = __webpack_require__(/*! ./parse */ 36);
var formats = __webpack_require__(/*! ./formats */ 35);
...
/***/ 37:
/*!***********************************************!*\
  !*** C:/Coding/Project/mhsh-wx/utils/util.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.bMapGetLocationInfo = bMapGetLocationInfo;exports.clearUserInfo = clearUserInfo;exports.getDate = getDate;exports.validForm = validForm;exports.validEmpty = validEmpty;exports.requestPayment = requestPayment;exports.goApp = goApp;exports.chooseImage = chooseImage;exports.uploadImage = uploadImage;exports.debounce = debounce;exports.throttle = throttle;var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 12));
var _config = _interopRequireDefault(__webpack_require__(/*! @/api/config */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */
function bMapGetLocationInfo() {var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  return new Promise(function (resolve, reject) {
    wx.getLocation({
...
function clearUserInfo() {
  ...
  _store.default.commit('setUserInfo', '');
  _store.default.commit('setCurrentProject', null);
...
function validForm(arr) {
  var status = arr.some(function (obj) {
...
function validEmpty(val, message) {
  var status = typeof val === 'undefined' || val === null || val === '';
  if (status) {
    uni.showToast({
      title: message || '值不能为空',
      icon: 'none' });
    ...
    params), {}, {
      success: function success(chooseImageRes) {
        ...
        if (tempFilePaths && tempFilePaths.length) {
          var result = tempFilePaths.map(function (filePath, index) {
            return uploadImage(filePath, index).then(function (url) {
...
function uploadImage(filePath, index) {
...
function throttle(func) {var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;
  var timer = null;
  return function () {
    if (!timer) {
...
/***/ 38:
/*!***********************************************!*\
  !*** C:/Coding/Project/mhsh-wx/api/config.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  baseUrl: 'https://develop.mhshjy.com'
  // baseUrl: 'https://test.tosolomo.com'
  // baseUrl: 'https://live.tosolomo.com'
};exports.default = _default;
...
/***/ 39:
/*!**************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/api/personage.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getEqList = getEqList;exports.getFeedbackList = getFeedbackList;exports.addFeedback = addFeedback;exports.getFeedbackInfo = getFeedbackInfo;exports.setPayPassword = setPayPassword;exports.yzPayPassword = yzPayPassword;exports.updatePayPassword = updatePayPassword;exports.resetPayPassword = resetPayPassword;exports.resetPassword = resetPassword;exports.setPassword = setPassword;exports.updatePassword = updatePassword;exports.getMemberList = getMemberList;exports.addMember = addMember;exports.updateMember = updateMember;exports.deleteMember = deleteMember;exports.bindingHouse = bindingHouse;exports.yzHouse = yzHouse;exports.roomAttest = roomAttest;exports.bindingRoomInfo = bindingRoomInfo;exports.bindingDefault = bindingDefault;exports.unBinding = unBinding;exports.searchProject = searchProject;exports.searchBuilding = searchBuilding;exports.searchUnit = searchUnit;exports.searchHouse = searchHouse;exports.getPaymentCode = getPaymentCode;exports.getCollectCode = getCollectCode;exports.paymentScan = paymentScan;exports.collectScan = collectScan;exports.paymentStatus = paymentStatus;exports.collectStatus = collectStatus;exports.paymentCredits = paymentCredits;exports.collectCredits = collectCredits;exports.skCredits = skCredits;exports.signin = signin;exports.signinCalendar = signinCalendar;exports.getCreditsAccount = getCreditsAccount;exports.getCreditsLog = getCreditsLog;exports.getCreditsInfo = getCreditsInfo;exports.getCreditsOrderList = getCreditsOrderList;exports.getYxlpList = getYxlpList;exports.recommendClient = recommendClient;exports.clientList = clientList;exports.clientCount = clientCount;exports.getMessageList = getMessageList;exports.getCountMessage = getCountMessage;exports.messageRead = messageRead;exports.messageAllRead = messageAllRead;exports.getAppMsgDetail = getAppMsgDetail;exports.editAvatar = editAvatar;exports.editNickname = editNickname;exports.editGender = editGender;exports.editBirthday = editBirthday;exports.editRealname = editRealname;exports.updateMobile = updateMobile;exports.getCoupon = getCoupon;exports.payOrderUp = payOrderUp;exports.getOrderList = getOrderList;exports.getOrderDetail = getOrderDetail;exports.getHomeSpecial = getHomeSpecial;exports.getSpecial = getSpecial;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 18));
var _config = _interopRequireDefault(__webpack_require__(/*! @/api/config */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 常见问题列表
function getEqList(params) {
  return (0, _request.default)({
...
// 意见反馈详情
function getFeedbackInfo(params) {
  return (0, _request.default)({
...
// 修改支付密码
function updatePayPassword(data) {
  return (0, _request.default)({
...
// 房间认证
function roomAttest(data) {
  return _request.default.post('/room/binding/roomAttest', data);
}

/* 认证房间详情 */
function bindingRoomInfo(params) {
  return (0, _request.default)({
...
function unBinding(data) {
  return _request.default.post('/room/binding/unBinding', data);
}

/* 检索小区 */
function searchProject(params) {
  return _request.default.get('/room/binding/searchProject', { params: params });
}

/* 检索楼栋 */
function searchBuilding(params) {
  return _request.default.get('/room/binding/searchBuilding', { params: params });
}
...
// 获取收款码二维码
function getCollectCode(params) {
  return (0, _request.default)({
...
// 签到
function signin() {
  return _request.default.post('/credits/account/signin');
}
// 签到日历数据
function signinCalendar(data) {
  return (0, _request.default)({
...
// 幸福币账户首页
function getCreditsAccount(data) {
  return (0, _request.default)({
...
// 幸福币订单购买记录
function getCreditsOrderList(data) {
  return _request.default.post('/life/order/credits_order_list', data);
}
// 意向楼盘列表
function getYxlpList() {
  return (0, _request.default)({
    url: '/hkt/tjgf/yxlpList' });

}
// 推荐客户
function recommendClient(data) {
  return (0, _request.default)({
...
// 统计未读消息
function getCountMessage(params) {
  return (0, _request.default)({
...
// 消息全部已读
function messageAllRead(data) {
  return (0, _request.default)({
    url: '/my/message/messageAllRead',
    method: 'post',
    data: data });

  return _request.default.post('/my/message/messageAllRead', data);
}
// 获取APP系统消息详情接口
function getAppMsgDetail(data) {
  return (0, _request.default)({
...
function editAvatar(data) {
  return _request.default.post('/my/account/editAvatar', data);
}
// 编辑昵称
function editNickname(data) {
  return _request.default.post('/my/account/editNickname', data);
}
// 编辑性别
function editGender(data) {
  return _request.default.post('/my/account/editGender', data);
}
// 编辑生日
function editBirthday(data) {
  return _request.default.post('/my/account/editBirthday', data);
}
// 编辑真实姓名
function editRealname(data) {
  return _request.default.post('/my/account/editRealname', data);
}
// 更换手机
function updateMobile(data) {
  return _request.default.post('/my/password/updateMobile', data);
}
/* 基础信息 end */
...
/***/ 390:
/*!**************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-load-more/components/uni-load-more/i18n/index.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 391));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 392));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 393));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
...
/***/ 391:
/*!*************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-load-more/components/uni-load-more/i18n/en.json ***!
  \*************************************************************************************************/
...
/***/ 392:
/*!******************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hans.json ***!
  \******************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 393:
/*!******************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hant.json ***!
  \******************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 40:
/*!**************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/filters/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.sexText = sexText;exports.houseRoleText = houseRoleText;exports.houseRoleColor = houseRoleColor;exports.privacyName = privacyName; /**
                                                                                                                                                                                                                       * 性别
                                                                                                                                                                                                                       * @param {String} value
                                                                                                                                                                                                                       */
...
/***/ 41:
/*!*************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/utils/router.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _util = __webpack_require__(/*! ./util */ 37);


var _appPathToWxPath = __webpack_require__(/*! ./appPathToWxPath.js */ 42);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _objectWithoutProperties(source, excluded) {if (source == null) return {};var target = _objectWithoutPropertiesLoose(source, excluded);var key, i;if (Object.getOwnPropertySymbols) {var sourceSymbolKeys = Object.getOwnPropertySymbols(source);for (i = 0; i < sourceSymbolKeys.length; i++) {key = sourceSymbolKeys[i];if (excluded.indexOf(key) >= 0) continue;if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue;target[key] = source[key];}}return target;}function _objectWithoutPropertiesLoose(source, excluded) {if (source == null) return {};var target = {};var sourceKeys = Object.keys(source);var key, i;for (i = 0; i < sourceKeys.length; i++) {key = sourceKeys[i];if (excluded.indexOf(key) >= 0) continue;target[key] = source[key];}return target;}var _default =
...

{
  push: function push(data) {
    ...
    data,url = _data.path,isApp = _data.isApp,query = _data.query,fail = _data.fail,params = _objectWithoutProperties(_data, ["path", "isApp", "query", "fail"]);
    var urls = url.split('?');
    var path = urls[0];
    // 轮播图专题页等自定义跳转页面，需将app地址转换为小程序地址
    if (isApp && url) {
      url = _appPathToWxPath.appPathToWxPath[path] || path;
      url += url + urls[1];
    }
    if (query) {
      Object.keys(query).forEach(function (key) {
        var value = "".concat(key, "=").concat(query[key]);
        url += url.indexOf('?') > -1 ? "&".concat(value) : "?".concat(value);
      });
    }
    var token = uni.getStorageSync('access_token');
    if (!token && !_appPathToWxPath.whiteListPaths.includes(path)) {
      uni.navigateTo({
        url: '/pages/index/login' });

      return;
    }
    var routerParams = _objectSpread({
      url: url,
      fail: fail || function (_ref)
    ...
    if (_appPathToWxPath.tabbarPaths.includes(url)) {
...
/***/ 42:
/*!**********************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/utils/appPathToWxPath.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.whiteListPaths = exports.tabbarPaths = exports.appPathToWxPath = void 0;var appPathToWxPath = {
  "/": "/pages/tabBar/home/home",
  "/login": "/pages/index/login",
  "/agreement": "/pages/index/agreement",
  "/personage": "/pages/tabBar/personage/personage",
  "/pages/personage/happiness-coin/index": "/pages/tabBar/credit/credit",
  "/pages/personage/setting/index": "/pages/personage/setting/index",
  "/pages/personage/feedback/index": "/pages/personage/feedback/index",
  "/pages/personage/feedback/list": "/pages/personage/feedback/list",
  "/pages/personage/feedback/details": "/pages/personage/feedback/detail",
  "/pages/personage/question/index": "/pages/personage/question/index",
  "/pages/personage/scanCode/index": "/pages/personage/scanCode/index",
  "/pages/personage/message/index": "/pages/personage/message/index",
  "/coupon/list": "/pages/personage/coupon/list",
  "/personage/shop/couponDetail": "/pages/personage/coupon/detail",
  "/personage/shop/couponPurchaseRecord": "/pages/personage/coupon/purchaseRecord",
  "/pages/personage/information/index": "/pages/personage/information/index",
  // "/pages/personage/information/phone": "/pages/personage/information/phone",
  "/pages/personage/information/payment-code": "/pages/personage/information/paymentCode",
  // "/pages/personage/information/login-password": "/pages/personage/information/loginPassword",
  "/pages/personage/information/forget-payment-code": "/pages/personage/information/forgetCode",
  "/pages/personage/information/personInfo": "/pages/personage/information/personInfo",
  "/pages/personage/house/attestation": "/pages/personage/house/attestation",
  "/pages/personage/house/select-community": "/pages/personage/house/selectCommunity",
  "/pages/personage/house/select-house": "/pages/personage/house/selectHouse",
  "/personage/shop/introduce": "/pages/personage/shop/introduce",
  "/personage/shop/location": "/pages/personage/shop/location",
  "/pages/personage/happiness-coin/coin-record": "/pages/credit/creditRecord",
  "/pages/personage/happiness-coin/details": "/pages/credit/creditDetail",
  "/pages/personage/happiness-coin/recomRecord": "/pages/credit/recomRecord",
  "/pages/personage/happiness-coin/recomBuyHouse": "/pages/credit/recomBuyHouse",
  "/pages/personage/happiness-coin/payment": "/pages/credit/payment" };exports.appPathToWxPath = appPathToWxPath;


var tabbarPaths = [
"/pages/tabBar/home/home",
"/pages/tabBar/personage/personage",
"/pages/tabBar/credit/credit"];exports.tabbarPaths = tabbarPaths;


var whiteListPaths = [
"/pages/tabBar/home/home",
"/pages/tabBar/personage/personage",
"/pages/tabBar/credit/credit",
"/pages/index/login",
"/pages/index/agreement"];exports.whiteListPaths = whiteListPaths;

/***/ }),

/***/ 469:
/*!****************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-search-bar/components/uni-search-bar/i18n/index.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 470:
/*!***************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-search-bar/components/uni-search-bar/i18n/en.json ***!
  \***************************************************************************************************/
...
/***/ 471:
/*!********************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hans.json ***!
  \********************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 472:
/*!********************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hant.json ***!
  \********************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 5:
/*!********************************************!*\
  !*** C:/Coding/Project/mhsh-wx/pages.json ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 537:
/*!************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/pages.json?{"type":"stat"} ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 538:
/*!******************************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-file-picker/components/uni-file-picker/choose-and-upload-file.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 536)["default"]))

/***/ }),

/***/ 539:
/*!*************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-file-picker/components/uni-file-picker/utils.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 582:
/*!*********************************************************************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 73:
/*!*****************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/utils/permission.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.handlePermission = handlePermission;exports.hasPermission = hasPermission;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));var _user = __webpack_require__(/*! @/api/user */ 17);
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       * }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */
function handlePermission(_ref)




{var name = _ref.name,_ref$message = _ref.message,message = _ref$message === void 0 ? '' : _ref$message,_ref$title = _ref.title,title = _ref$title === void 0 ? '提示' : _ref$title,_ref$confirmButtonTex = _ref.confirmButtonText,confirmButtonText = _ref$confirmButtonTex === void 0 ? '去开启' : _ref$confirmButtonTex;
  return new Promise(function (resolve, reject) {
    hasPermission(name).then(function () {
      resolve();
    }).catch(function () {
      var scope = "scope.".concat(name);
      uni.authorize({
        scope: scope,
...
/**
   ...
   * {scope.address: true}
   */function
hasPermission(_x) {return _hasPermission.apply(this, arguments);}function _hasPermission() {_hasPermission = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(perm) {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return",
            new Promise(function (resolve, reject) {
              uni.getSetting({
                success: function success(res) {
                  var setting = res.authSetting;
                  var key = "scope.".concat(perm);
                  if (setting[key]) {
            ...
            }));case 1:case "end":return _context.stop();}}}, _callee);}));return _hasPermission.apply(this, arguments);}



function getCurrentLocation(resolve, reject) {
  // 开启定位，则获取用户的定位信息保存在后端
  var hasToken = uni.getStorageSync('access_token');
  hasToken && (0, _util.bMapGetLocationInfo)().
  then(function (data) {var

    longitude =

    data.longitude,latitude = data.latitude;
    (0, _user.setUserPostion)({
      longitude: longitude,
      latitude: latitude }).
    finally(function () {
      resolve();
...
/***/ 82:
/*!*******************************************************!*\
  !*** C:/Coding/Project/mhsh-wx/api/personage/shop.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getShopInformation = getShopInformation;exports.getShopCouponBanner = getShopCouponBanner;exports.getCouponReceiveList = getCouponReceiveList;exports.receiveCoupon = receiveCoupon;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 商铺 店铺信息数据 接口
function getShopInformation(data) {
  return (0, _request.default)({
...
// 商铺券 banner条 接口
function getShopCouponBanner(data) {
  return (0, _request.default)({
...
// 商铺券 可领取列表 接口
function getCouponReceiveList(data) {
  return (0, _request.default)({
